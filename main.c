...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/07/17 23:53:56 by abadalya          #+#    #+#             */
/*   Updated: 2021/07/17 23:59:44 by abadalya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	strlen_test(char *str)
{
	...
	ret1 = ft_strlen(str);
	ret2 = strlen(str);
	printf("strlen : %d / ft_strlen : %d", ret2, ret1);
	if (ret1 == ret2)
		printf("" GREEN " [OK] \n" RESET "");
	else
		printf("" RED " [KO] \n" RESET "");
...
int	strcmp_test(char *s1, char *s2)
{
	...
	ret2 = strcmp(s1, s2);
	printf("strcmp : %d / ft_strcmp : %d", ret2, ret1);
